...
export function PublicMenuItemCard({
  ...
  return (
    <article className="group relative h-[31.5rem] [perspective:1800px] sm:h-[32.5rem]">
      <div
        className="relative h-full w-full transition-transform duration-700 [transform-style:preserve-3d]"
        style={{ transform: flipped ? 'rotateY(180deg)' : 'rotateY(0deg)' }}
      >
        <div className="absolute inset-0 [backface-visibility:hidden]">
          <div className="relative flex h-full flex-col overflow-hidden rounded-[1.7rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(10,10,25,0.96),rgba(7,7,14,0.98))] shadow-[0_20px_65px_rgba(0,0,0,0.38)] transition-all duration-300 group-hover:-translate-y-1 group-hover:border-white/14 group-hover:shadow-[0_30px_80px_rgba(0,0,0,0.46)]">
            ...
            <div className="relative p-4">
              ...
              <div className="mt-5 flex items-start justify-between gap-4">
                ...
                <div className="shrink-0 rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 text-[10px] font-black uppercase tracking-[0.24em] text-white/48">
                  {hasModifiers
              ...
              <p className="mt-4 line-clamp-2 text-sm leading-6 text-white/44">
                {teaser}
              </p>

              <div className="mt-5 grid grid-cols-[1fr_auto] items-center gap-3 rounded-[1.25rem] border border-white/[0.08] bg-white/[0.03] px-4 py-3.5">
                <div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-[10px] font-black uppercase tracking-[0.24em] text-cyan-300 transition-all duration-300 hover:border-cyan-300/55 hover:bg-cyan-400/14"
        ...
        <div className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)]">
          <div className="relative flex h-full flex-col overflow-hidden rounded-[1.7rem] border border-cyan-400/15 bg-[linear-gradient(180deg,rgba(8,11,22,0.98),rgba(8,8,18,0.98))] shadow-[0_20px_65px_rgba(0,0,0,0.42)]">
            ...
            <div className="flex items-start justify-between gap-4 border-b border-white/[0.08] px-4 py-4">
              ...
              <button
                ...
                className="shrink-0 rounded-full border border-white/12 bg-white/[0.04] px-3 py-2 text-[10px] font-black uppercase tracking-[0.24em] text-white/72 transition-all duration-300 hover:border-pink-400/35 hover:text-pink-300"
                ...
                {hasModifiers ? (
                  ...
                  <div className="rounded-2xl border border-dashed border-white/12 bg-white/[0.03] p-4">
                    ...
                    <p className="mt-3 text-sm leading-6 text-white/46">
                      No optional modifiers are attached right now. The base dish is
                      already plated as the full intended flavor profile.
                    </p>
                  </div>
                )}
              </div>
