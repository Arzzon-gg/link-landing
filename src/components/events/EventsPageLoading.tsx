      ...
      <div className="mx-auto max-w-7xl space-y-10">
        <section className="relative overflow-hidden rounded-[2.25rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(10,10,25,0.94),rgba(7,7,14,0.98))] px-6 py-10 sm:px-8 sm:py-14">
          ...
          <div className="relative flex min-h-[300px] flex-col items-center justify-center gap-5 sm:min-h-[340px]">
            ...
            <SkeletonBlock className="h-6 w-full max-w-xl rounded-2xl bg-white/6" />
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-center gap-5">
            <SkeletonBlock className="h-px w-16 bg-white/10 sm:w-24" />
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {Array.from({ length: 6 }).map((_, index) => (
              ...
              >
                <div className="menu-shimmer aspect-[16/10] rounded-[1.3rem] bg-white/8" />
                ...
                <SkeletonBlock className="mt-4 h-6 w-40 rounded-full bg-white/6" />
                <SkeletonBlock className="mt-5 h-20 rounded-3xl bg-white/8" />
              </div>
            ))}
          </div>
        </section>
